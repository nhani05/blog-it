...
INSERT INTO comment (post_id, user_id, content, status) VALUES
(2, 1, 'Bài viết rất hay và dễ hiểu!', 'approved'),
(2, 2, 'Cảm ơn phản hồi của bạn!', 'approved'),
(1, 2, 'Tôi đang gặp lỗi khi sử dụng @OneToMany trong Entity...','pending');
